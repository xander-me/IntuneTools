...
| [Get-AutopilotHardwareHash.ps1](Autopilot/Get-AutopilotHardwareHash/README.md) | Silent Autopilot hardware hash collection and direct Intune import with group tag (ManageEngine), Danish guide | Windows 10 1703+/11 as SYSTEM, Windows PowerShell 5.1, app-only Graph credentials with DeviceManagementServiceConfig.ReadWrite.All supplied at run time |
...
The 2026-09-21 review parsed the scripts without executing Graph or Windows Update operations. Get-AutopilotHardwareHash has a Pester suite (mocked); no representative tenant/Windows acceptance evidence is committed for any script.
